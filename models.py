...
class Entity(db.Model):
    ...
    def __init__(self,id, name, source, features_periodic, formula_periodic, features_realtime, formula_realtime, result_count):
        self.id = id
        self.name = name
        self.source = source 
    ...
    def __reprt__(self):
        return f"""{self.id}. {self.name}:
         source: {self.source}
         features_periodic: {self.features_periodic} formula_period: {self.formula_periodic}
